...
// Fieldstone OpenAPI global metadata. Run `make swagger` to regenerate the spec.
//
...
// @description
// @description     **Development**: set `DEV_DISABLE_AUTH=true` in .env to bypass JWT
// @description     validation locally. Remove before production deployment.
//
